...
public class ParolaUitataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText email = findViewById(R.id.et_e_mail_parola);
        final EditText message = findViewById(R.id.et_mesaj_parola);

        message.setText("Buna ziua. " + "\n" + "Mi-am uitat parola. Va rog sa o resetati. " + "\n" + "Va multumesc! ");

        Button send = findViewById(R.id.btn_trimite_parola);
