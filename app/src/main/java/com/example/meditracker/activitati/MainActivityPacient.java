...
public class MainActivityPacient extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_tratament) {
            Intent intent = new Intent(getApplicationContext(), TratamentActivity.class);
            startActivity(intent);
        }  else if (id == R.id.nav_internari) {
            Intent intent = new Intent(getApplicationContext(), InternariActivity.class);
            startActivity(intent);
